...
(function ($) {
  var settings = {}, roots = {}, caches = {},
    ...
    view = {
      ...
      makeDOMNodeMainBefore: function (html, setting, node) { //yuchuang ↓<p>
        html.push("<li id='", node.tId, "' class='animated fadeInLeft ", consts.className.LEVEL, node.level, "' tabindex='0' hidefocus='true' treenode> <p class='addbor'>");
      },
